...
$body = new \Skyapi\Model\InlineObject(); // \Skyapi\Model\InlineObject | 

try {
    $result = $apiInstance->walletTransaction($body);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Skyapi\Model\InlineObject**](../Model/InlineObject.md)|  |
