...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://127.0.0.1:6420';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.27.0/PHP';
    ...
    {
        $report  = 'PHP SDK (SkyApi) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.27.0' . PHP_EOL;
        $report .= '    SDK Package Version: 0.27.0' . PHP_EOL;
