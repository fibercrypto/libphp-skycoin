...
class InlineResponse2002 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'inner_hash' => 'string',
        'inputs' => '\Skyapi\Model\ApiV1ExplorerAddressInputs[]',
        'fee' => 'int',
        'sigs' => 'string[]',
        'length' => 'int',
        'txid' => 'string',
        'type' => 'int',
        'status' => '\Skyapi\Model\ApiV1ExplorerAddressStatus',
        'timestamp' => 'int'
    ];
     ...
     * Gets inputs
     *
     * @return \Skyapi\Model\ApiV1ExplorerAddressInputs[]|null
     */
     ...
     * Sets inputs
     *
     * @param \Skyapi\Model\ApiV1ExplorerAddressInputs[]|null $inputs inputs
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \Skyapi\Model\ApiV1ExplorerAddressStatus|null
     */
     ...
     * Sets status
     *
     * @param \Skyapi\Model\ApiV1ExplorerAddressStatus|null $status status
     *
     * @return $this
     */
