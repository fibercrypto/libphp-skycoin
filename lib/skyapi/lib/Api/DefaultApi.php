...
class DefaultApi
{
     ...
     *
     * @param  \Skyapi\Model\InlineObject $inline_object inline_object (optional)
     *
     * @throws \Skyapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Skyapi\Model\InlineResponseDefault
     */
    public function walletTransaction($inline_object = null)
    {
        list($response) = $this->walletTransactionWithHttpInfo($inline_object);
        return $response;
    }
     ...
     *
     * @param  \Skyapi\Model\InlineObject $inline_object (optional)
     *
     * @throws \Skyapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Skyapi\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function walletTransactionWithHttpInfo($inline_object = null)
    {
        $request = $this->walletTransactionRequest($inline_object);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function walletTransactionAsync($inline_object = null)
    {
        return $this->walletTransactionAsyncWithHttpInfo($inline_object)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function walletTransactionAsyncWithHttpInfo($inline_object = null)
    {
        $returnType = 'object';
        $request = $this->walletTransactionRequest($inline_object);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function walletTransactionRequest($inline_object = null)
    {
